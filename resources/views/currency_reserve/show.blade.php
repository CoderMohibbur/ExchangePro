        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="container mx-auto px-4 py-4">
                <div class="rounded-lg shadow-lg bg-white dark:bg-gray-800 p-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('currency_reserve.index') }}" class="px-4 py-2 bg-gray-500 text-white font-semibold rounded hover:bg-gray-600">Back to List</a>
                        <a href="{{ route('currency_reserve.edit', $currencyReserve) }}" class="px-4 py-2 bg-yellow-500 text-white font-semibold rounded hover:bg-yellow-600">Edit</a>
                    </div>
                </div>
            </div>
        </div>
