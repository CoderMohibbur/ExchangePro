<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl dark:text-white font-semibold">Manage Currency Reserve Transactions</h1>
    </x-slot>
            ...
            <div class="container mx-auto px-4 py-4">
                <div class="rounded-lg shadow-lg bg-white dark:bg-gray-800">
                    ...
                    <div class="flex justify-between items-center p-4">
                        ...
                        <a href="{{ route('currency_reserve_transactions.create') }}" 
                                ...
                                @forelse($transactions as $transaction)
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 flex space-x-2">
                                            <a href="{{ route('currency_reserve_transactions.edit', $transaction) }}" 
                                            ...
                                            <form action="{{ route('currency_reserve_transactions.destroy', $transaction) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
