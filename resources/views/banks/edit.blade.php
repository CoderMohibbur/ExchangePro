                        ...
                        <div class="grid gap-4 grid-cols-2">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="beneficiary_name" id="beneficiary_name"
                                    value="{{ old('beneficiary_name', $bank->beneficiary_name) }}" required
                                    class="form-control w-full mt-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="account_type" id="account_type" required
                                    ...
                                    <option value="checking"
                                        {{ old('account_type', $bank->account_type) == 'checking' ? 'selected' : '' }}>
                                        Checking</option>
                                    <option value="savings"
                                        {{ old('account_type', $bank->account_type) == 'savings' ? 'selected' : '' }}>
                                        Savings</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="routing" id="routing"
                                    value="{{ old('routing', $bank->routing) }}" required
                                    class="form-control w-full mt-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="bank_address" id="bank_address"
                                    value="{{ old('bank_address', $bank->bank_address) }}" required
                                    class="form-control w-full mt-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.01" name="npsb_fee" id="npsb_fee"
                                    value="{{ old('npsb_fee', $bank->npsb_fee) }}" required
                                    class="form-control w-full mt-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.01" name="eft_beftn_fee" id="eft_beftn_fee"
                                    value="{{ old('eft_beftn_fee', $bank->eft_beftn_fee) }}" required
                                    class="form-control w-full mt-1 bg-gray-100 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                @if($bank->logo)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $bank->logo) }}" alt="Bank Logo"
