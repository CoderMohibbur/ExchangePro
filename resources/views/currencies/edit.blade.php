                    ...
                    <form action="{{ route('currencies.update', $currency) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-6 grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="number" name="exchange_rate" step="0.0001" value="{{ old('exchange_rate', $currency->exchange_rate) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="cur_sym" value="{{ old('cur_sym', $currency->cur_sym) }}"
                                    class="w-full mt-1 border rounded p-2 dark:bg-gray-700 dark:text-gray-300">
                                @error('cur_sym')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="hidden">
                                ...
                                <input type="number" name="reserve" step="0.01" value="{{ old('reserve', $currency->reserve) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="fixed_charge_for_buy" step="0.01"
                                    value="{{ old('fixed_charge_for_buy', $currency->fixed_charge_for_buy) }}"
                                    class="w-full mt-1 border rounded p-2 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                ...
                                <input type="number" name="percent_charge_for_buy" step="0.01"
                                    value="{{ old('percent_charge_for_buy', $currency->percent_charge_for_buy) }}"
                                    class="w-full mt-1 border rounded p-2 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                ...
                                <input type="number" name="fixed_charge_for_sell" step="0.01"
                                    value="{{ old('fixed_charge_for_sell', $currency->fixed_charge_for_sell) }}"
                                    class="w-full mt-1 border rounded p-2 dark:bg-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                ...
                                <input type="number" name="percent_charge_for_sell" step="0.01"
                                    value="{{ old('percent_charge_for_sell', $currency->percent_charge_for_sell) }}"
                                    class="w-full mt-1 border rounded p-2 dark:bg-gray-700 dark:text-gray-300">
