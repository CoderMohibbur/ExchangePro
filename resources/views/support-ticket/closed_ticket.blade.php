<x-app-layout>
    <x-slot name="header">
        <h1 class=" text-xl dark:text-white font-semibold">Support Tickets
                        ...
                        <table
                            ...
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left font-semibold">Priority</th>
                                    <th class="px-4 py-2 text-left font-semibold">Last Reply</th>
