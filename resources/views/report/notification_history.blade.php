<x-app-layout>
    <x-slot name="header">
        <h1 class=" text-xl dark:text-white font-semibold">Notification History
                        ...
                        <table
                            ...
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left font-semibold">Commission From	</th>
                                    <th class="px-4 py-2 text-left font-semibold">Commission Level	</th>
