<x-app-layout>
            ...
            <div class="container mx-auto">
                <div class="rounded-lg shadow-lg bg-white dark:bg-gray-900">
                    ...
                    <div class="flex justify-between p-4 items-center">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Bank Transactions</h2>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            const dataTable = new simpleDatatables.DataTable("#bank-transactions", {
                searchable: true,
                sortable: true
            });
        });
